...
data class TorrentSessionOptions constructor(
    ...
    init {
        ...
        settingsPack.setInteger(settings_pack.int_types.suggest_mode.swigValue(),settings_pack.suggest_mode_t.no_piece_suggestions.swigValue())
        settingsPack.setBoolean(settings_pack.bool_types.prefer_udp_trackers.swigValue(),false)
