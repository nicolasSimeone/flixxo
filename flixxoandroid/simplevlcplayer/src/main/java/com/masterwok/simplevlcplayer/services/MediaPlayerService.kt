...
class MediaPlayerService : InjectableService(), MediaPlayer.Callback, Dialog.Callbacks {
    ...
    private var stateBuilder: PlaybackState.Builder? = null
...
//        }
    ...
    private fun getMediaMetadata(bitmap: Bitmap?): MediaMetadata {
    ...
    private fun createMediaSession() {
        mediaSession = MediaSession(this, SimpleVlcSessionTag).apply {
