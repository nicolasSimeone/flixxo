...
public class SelectionListAdapter<T> extends BaseAdapter {
    ...
    private List<Subtitle> selectionItems;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Subtitle selectionItem = getItem(position);
    ...
    private void fillValues(
        ...
        checkMarkImageView.setVisibility(
                selectionItem.isSelected() ? View.VISIBLE : View.INVISIBLE
        );

        itemNameTextView.setText(
                selectionItem.getLangName()
        );
    }
     ...
     */
    public void configure(List<Subtitle> selectionItems) {
        this.selectionItems = selectionItems;
